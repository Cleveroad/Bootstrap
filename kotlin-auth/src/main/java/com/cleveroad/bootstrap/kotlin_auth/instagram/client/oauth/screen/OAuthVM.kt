...
import com.cleveroad.bootstrap.kotlin_auth.instagram.client.oauth.PARAM_AUTH_CODE
import com.cleveroad.bootstrap.kotlin_auth.instagram.client.oauth.network.NetworkModule
...
class OAuthVM(application: Application) : BaseLifecycleViewModel(application) {
    ...
    private val authModule = NetworkModule.client.instagramOAuth
