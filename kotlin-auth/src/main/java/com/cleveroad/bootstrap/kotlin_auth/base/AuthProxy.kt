...
import com.cleveroad.bootstrap.kotlin_auth.instagram.InstagramAuthCallback
import com.cleveroad.bootstrap.kotlin_auth.instagram.InstagramAuthHelper
...
class AuthProxy {
    ...
    fun registerInstagramAuthHelper(clientId: String,
                                    clientSecret: String,
                                    scopes: List<String>,
                                    callbackUrl: String,
                                    callback: InstagramAuthCallback) {
        authHelpers[AuthType.INSTAGRAM_AUTH] =
                InstagramAuthHelper(clientId, clientSecret, scopes, callbackUrl, callback)
    }
