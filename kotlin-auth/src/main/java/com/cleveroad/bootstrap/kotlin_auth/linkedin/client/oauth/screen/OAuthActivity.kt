...
import com.cleveroad.bootstrap.kotlin_auth.linkedin.client.AuthHandler.Companion.EXTRA_ACCESS_TOKEN
import com.cleveroad.bootstrap.kotlin_auth.linkedin.client.AuthHandler.Companion.EXTRA_AUTH_ERROR
    ...
    companion object {
        ...
        fun start(activity: Activity,
                ...
                activity.startActivityForResult(newIntent(activity, clientId,
                        clientSecret, scopes, callbackUrl), LINKEDIN_AUTH_REQUEST_CODE).returnTrue()
