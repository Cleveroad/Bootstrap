...
class PhoneActivity : BaseLifecycleActivity<PhoneVM>(), PhoneViewCallback, BlockedCallback {

    companion object {
        fun start(context: Context) = context.startActivity(Intent(context, PhoneActivity::class.java))
    }
    ...
    override val viewModelClass = PhoneVM::class.java
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        savedInstanceState ?: replaceFragment(PhoneViewFragment.newInstance(), false)
    }
